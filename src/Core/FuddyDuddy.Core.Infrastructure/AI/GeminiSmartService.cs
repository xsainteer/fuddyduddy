...
public class GeminiSmartService : IGeminiSmartService
{
    private readonly IHttpClientFactory _httpClientFactory;
    private readonly ILogger<GeminiSmartService> _logger;
    private readonly IOptions<GeminiSmartOptions> _geminiOptions;

    public GeminiSmartService(IOptions<GeminiSmartOptions> geminiSmartOptions, ILogger<GeminiSmartService> logger, IHttpClientFactory httpClientFactory)
    {
        _geminiOptions = geminiSmartOptions;
        _logger = logger;
